    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                ...
                <a class="sidebar-brand brand-logo-mini" href="{{ route('dashboard') }}"><img src="images/logo-mini.png" alt="logo" /></a>
            </div>
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#dashboard" aria-expanded="true" aria-controls="dashboard">
                        <span class="menu-icon">
                            <i class="mdi mdi-speedometer" style="color:#fff;"></i>
                        </span>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#registers" aria-expanded="false" aria-controls="registers">
                        <span class="menu-icon">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#cpanel" aria-expanded="false" aria-controls="cpanel">
                        <span class="menu-icon">
